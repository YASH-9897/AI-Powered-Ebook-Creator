...
const Footer = () => {
    return (
        <footer className="relative bg-linear-to-br from-gray-950 via-gray-950 to-violet-950 text-white overflow-hidden">
            ...
            <div className="relative max-w-7xl mx-auo px-6 lg:px-8">
                <div className="py-16 grid grid-cols-1 md:grid-cols-12 gap-12">
                    {/* Brand Section */}
                    <div className="md:col-span-5 space-y-6">
                        <a href="/" className="flex items-center space-x-2.5 group">
                            <div className="w-10 h-10 bg-linear-to-br from-violet-500 to-purple-600 rounded-xl flex items-center justify-center shadow-lg shadow-violet-500/30 group-hover:shadow-violet-500/50 transition-all duration-300 group-hover:scale-110">
                    ...
                    {/* Quick Links */}
                    <div className="md:col-span-7 grid grid-col-2 sm:grid-cols-3 gap-8">
                        <div>
                        ...
                        <div>
                            ...
                            <ul className="space-y-3">
                                <li>
                                    <a href="#about" className="text-gray-400 hover:text-violet-400 transition-colors duration-200 text-sm">About
                                    </a>
                                </li>
                                <li>
                                    <a href="#contact" className='text-gray-400 hover:text-violet-400 transition-colors duration-200 text-sm'>Contact Us</a>
                                </li>
                                <li>
                                    <a href="#blog" className="text-gray-400 hover:text-violet-400 transition-colors duration-200 text-sm">Blog
                                    </a>
                                </li>
                            </ul>
                        </div>
                ...
                <div className="border-t border-white/10 py-8">
                    <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                        ...
                        <p className="text-gray-400 text-sm ">
                            Made with <span className="text-violet-400">❤️</span> for creators</p>
                    </div>
                </div>
            </div>
        </footer >
