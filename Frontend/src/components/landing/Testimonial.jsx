                        ...
                        >
                            ...
                            <div className="flex items-center space-x-4">
                                <div className="relative">
                                    <div className="absolute inset-0 bg-linear-to-br from-violet-500 to-purple-500 rounded-full blur opacity-30"></div>
                                    <img className="relative w-14 h-14 rounded-full object-cover ring-2 ring-white shadow-lg" src={testimonial.avatar}
