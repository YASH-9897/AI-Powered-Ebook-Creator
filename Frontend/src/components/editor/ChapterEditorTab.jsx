    ...
    return <div className={`${isFullscreen ? 'fixed inset-0 z-50 bg-white' : 'flex-1'} flex flex-col`}>
        ...
        <div className="border-b border-gray-100 bg-white">
            <div className="px-8 py-6">
                <div className="flex flex-col md:flex-row md:items-centre gap-4 md:gap-0 justify-between">
                    <div>
                    ...
                    <div className="flex items-center gap-3">
                        {/* Editor Controls */}
                        <div className="flex items-centre border border-gray-700 rounded-lg overflow-hidden ">
                            <button
                        ...
                        <div className="flex-1 min-h-0">
                            {isPreviewMode ? (
                                <div className="h-full border border-gray-200 rounded-lg overflow-y-auto">
                                    ...
                                    <div className="p-8">
                                        <h1 className="text-3xlfont-bold mb-6 text-gray-900">
